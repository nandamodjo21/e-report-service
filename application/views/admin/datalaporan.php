...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <!-- <button type="button" data-toggle="modal" data-target="#adddatalaporanModal"
                class="btn btn-primary mb-3">Tambah Data Laporan</button> -->
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $l->sts; ?></td>
                        <td>
                            <a href="" data-toggle="modal" data-target="#verifsiswaModal<?= $l->id_laporan; ?>"
                                class="badge badge-primary">Verifikasi</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
    ...
    <div class="modal fade" id="adddatalaporanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
